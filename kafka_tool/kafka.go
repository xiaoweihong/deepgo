	...
	go func() {
		for msg := range messages {
			...
			if genericObj.ObjType == go_kafka.ObjType_OBJ_TYPE_CAR {
				...
				glog.V(1).Infoln("vehicle--->" + vehicleobj.GetVehicle()[0].GetImg().GetImg().URI)
				...
				glog.V(1).Infoln("vehicle--->" + NonMotorVehicleObj.GetNonMotorVehicles()[0].GetImg().GetImg().URI)
				...
				glog.V(1).Infoln(NonMotorVehicleObj.GetNonMotorVehicles()[0].GetImg().GetImg().URI)
				glog.V(6).Infoln(NonMotorVehicleObj)
				glog.Infoln("************************************************")
				...
				glog.V(1).Infoln(pedestrianObj.GetPedestrian()[0].GetImg().GetImg().URI)
				...
				glog.V(1).Infoln(faceObj.GetFaces()[0].GetImg().GetImg().URI)
